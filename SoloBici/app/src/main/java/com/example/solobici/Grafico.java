...
public class Grafico {
	...
	private int radioColision; // Para determinar si chocamos con alg�n objeto
	...
	public void dibujaGrafico(Canvas canvas) {
		...
		canvas.restore();
		//Calculamos el �rea donde no podr�n solaparse/chocar
		//otros gr�ficos con este
		int rInval = (int) distanciaE(0, 0, ancho, alto) / 2 + MAX_VELOCIDAD;
		view.invalidate(x - rInval, y - rInval, x + rInval, y + rInval);
	};

	//Correcciones de posici�n en caso de que el gr�fico se salga de la pantalla
	...
	//Nos devuelve si se produce o no colisi�n entre dos objetos
