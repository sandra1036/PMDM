...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<9;i++){//coges los id de las imagenes
            ...
            RandomUtlils.randomElement(imagenes);
            RandomUtlils.randomInt(9);
            imagenes[i].setImageResource(imageViews[i]);
        ...
        for(int i=0;i<9;i++){//Clickas en cada imagen
            ...
            imagenes[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    imageresoult.setImageResource(imageViews[finalI]);//Coge los drawables y lo ponen en ImageView para mostrar la imagen
